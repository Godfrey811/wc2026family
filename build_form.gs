/**
 * Auto-builds the WC 2026 Family Pool Google Form with the exact 11 questions
 ...
 */
function buildPool() {
  var form = FormApp.create('WC 2026 Family Pool - Prediction Sheet')
      .setDescription('Predict 11 things for the 2026 World Cup. One entry per person. ' +
                      'Read the stats guide first: https://godfrey811.github.io/wc2026family/guide.html');
  ...
  form.addMultipleChoiceItem().setTitle('Q11. Total goals - band')
      .setChoiceValues(['<270','270-285','286-300','>300']).setRequired(true);
